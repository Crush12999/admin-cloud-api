...
import com.sryzzz.common.base.constant.SecurityConstants;
import com.sryzzz.common.base.result.ResultCode;
import com.sryzzz.gateway.util.ResponseUtils;
 ...
 *
 * @author sryzzz
 * @create 2022/9/11 22:43
 * @description 设置对哪些请求进行拦截，和如何解析token内容
 */
@AllArgsConstructor
@Configuration
